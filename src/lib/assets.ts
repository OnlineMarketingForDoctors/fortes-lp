...
// Male-oriented imagery for the non-surgical hair loss LP, generated with
// Higgsfield nano_banana_pro and stored locally (resized + compressed).
export const ns = {
  prpInjection: "/assets/nonsurgical/prp-injection.jpg",
  prfCentrifuge: "/assets/nonsurgical/prf-centrifuge.jpg",
  exosomeVials: "/assets/nonsurgical/exosome-vials.jpg",
  regeneraPunch: "/assets/nonsurgical/regenera-punch.jpg",
  iconPrp: "/assets/nonsurgical/icon-prp.jpg",
  iconPrf: "/assets/nonsurgical/icon-prf.jpg",
  iconExosomes: "/assets/nonsurgical/icon-exosomes.jpg",
  iconRegenera: "/assets/nonsurgical/icon-regenera.jpg",
  manMirror: "/assets/nonsurgical/man-mirror.jpg",
  consultDermatoscope: "/assets/nonsurgical/consult-dermatoscope.jpg",
  treatmentChair: "/assets/nonsurgical/treatment-chair.jpg",
