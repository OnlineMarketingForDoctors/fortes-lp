...
const reviews: Review[] = [
  {
    ...
    initial: "I",
    date: "5 months ago",
    body: "It's been a year since my eyebrow transplant with Dr. Ahmad and his team, and I finally feel ready to share my review. I'm so happy with the results. Dr. Ahmad offered plenty of follow-up sessions to check on growth, which made me feel really supported. A year later it all looks full and natural. I would 100% recommend Dr. Ahmad and his team.",
  ...
  },
  {
    ...
    initial: "C",
    date: "Recent",
    body: "I had such a good experience at Fortes Clinic. The consultation process was really straightforward and reassuring, as I got to talk directly with Dr Ahmad Saeed, rather than a sales-type person. I was kept informed about everything and didn't feel a thing. The results are amazing.",
  ...
  },
  {
    ...
    initial: "R",
    date: "Recent",
    body: "I'm so happy with my result. A lot of compliments from everyone. Thanks Dr Ahmad and the whole team, I'm really happy I chose Fortes Clinic.",
