...
export default function FloatingCTA() {
  return (
    <a
      ...
      className="hidden sm:flex fixed right-0 top-1/2 -translate-y-1/2 z-40 w-[104px] py-6 px-4
    ...
    >
      ...
      <span className="font-ui uppercase text-[10px] leading-[1.5] font-bold tracking-[0.03em]">
        Free
        <br />
        Consultation
      </span>
